...
class Progresspoll(NamedTuple):
    """poll of progress for a given time."""
...
class Task:
    ...
    _progress: Deque[Progresspoll] = field(
    ...
    def speed(self) -> Optional[float]:
        ...
        with self._lock:
            ...
            next(iter_progress)
            total_completed = sum(poll.completed for poll in iter_progress)
    ...
    def update(
        ...
        **fields: Any,
        ...
        with self._lock:
            ...
            current_time = self.get_time()
            old_poll_time = current_time - self.speed_estimate_period
            _progress = task._progress

            popleft = _progress.popleft
            while _progress and _progress[0].timestamp < old_poll_time:
                popleft()
            while len(_progress) > 1000:
                popleft()
            if update_completed > 0:
                _progress.append(Progresspoll(current_time, update_completed))
